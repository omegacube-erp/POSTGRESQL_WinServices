...
Public Class ProjectInstaller
    ...
    Protected Shared strLogFilePath As String = AppPath + "\" + "event_scheduler_PG.txt"
    Private Shared sw As StreamWriter = Nothing

    Public source As String = "EDGEevent_scheduler_PG"
    Public log As String = "EDGEevent_scheduler_PG"
    ...
    Private Sub ProjectInstaller_AfterUninstall(ByVal sender As System.Object, ByVal e As System.Configuration.Install.InstallEventArgs) Handles MyBase.AfterUninstall
        Try
    ...
    Private Sub ProjectInstaller_BeforeUninstall(ByVal sender As System.Object, ByVal e As System.Configuration.Install.InstallEventArgs) Handles MyBase.BeforeUninstall
        Try
            Dim controller As New ServiceController(ServiceInstallerevent_scheduler_PG.ServiceName)
