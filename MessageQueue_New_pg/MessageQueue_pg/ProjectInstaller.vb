...
Public Class ProjectInstaller
    ...
    Protected Shared strLogFilePath As String = AppPath + "\" + "EDGEQueryExLog_PG.txt"
    Private Shared sw As StreamWriter = Nothing

    Public source As String = "EDGEMsgQExLogSource_PG"
    Public log As String = "EDGEMsgQExLog_PG"
    ...
    Private Sub ProjectInstaller_BeforeUninstall(ByVal sender As System.Object, ByVal e As System.Configuration.Install.InstallEventArgs) Handles MyBase.BeforeUninstall
        Try
            Dim controller As New ServiceController(ServiceInstallerMQueue_PG.ServiceName)
