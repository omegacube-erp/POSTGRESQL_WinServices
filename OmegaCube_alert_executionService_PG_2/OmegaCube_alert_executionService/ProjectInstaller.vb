...
Public Class ProjectInstaller
    ...
    Protected Shared strLogFilePath As String = AppPath + "\" + "AlertExecution_ExLog.txt"
    ...
    Private Sub ProjectInstaller_BeforeUninstall(sender As Object, e As InstallEventArgs) Handles Me.BeforeUninstall
        Try
            Dim controller As New ServiceController(AlertexecutionServiceInstaller_PG.ServiceName)
